...
/**
 * Verifies that the {@code phoniebox-audio} module respects onion-architecture layer boundaries and
 * domain model conventions as defined by {@link OnionArchitectureRules}.
 */
class ArchitectureTest {

  private static final String BASE_PACKAGE = "eu.noxone.phoniebox.audio";
