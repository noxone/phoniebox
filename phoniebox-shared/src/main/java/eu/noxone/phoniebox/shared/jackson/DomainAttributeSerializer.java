 ...
 *
 * <p>Unwraps the attribute value via {@link DefaultDomainAttribute#getValue()}
 * and delegates serialization to Jackson's standard pipeline for that value's
 * type.  This means {@code MimeType("audio/mpeg")} serializes as
 * {@code "audio/mpeg"}, {@code FileSize(1024)} as {@code 1024}, and
 * {@code UploadedAt(Instant)} as an ISO-8601 string — exactly as if the field
 * were declared with the primitive type directly.
 *
...
public class DomainAttributeSerializer extends StdSerializer<DefaultDomainAttribute<?>> {
    ...
    @Override
    public void serialize(final DefaultDomainAttribute<?> value,
