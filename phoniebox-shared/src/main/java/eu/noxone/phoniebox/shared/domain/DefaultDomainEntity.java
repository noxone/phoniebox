 ...
 *
 * <p>Provides identity-based {@link #equals} and {@link #hashCode}: two entities of the same
 * concrete type are equal if and only if their IDs are equal. Subclasses must expose their ID via
 * {@link #getId()}.
 *
 * <p>Typical usage:
 *
 ...
 * }</pre>
 *
 * @param <ID> the type of the entity's identity attribute; must itself be a {@link DomainAttribute}
 */
