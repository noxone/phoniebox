 ...
 *
 * <p>Extends {@link DefaultDomainAttribute}{@code <UUID>} to inherit value equality, hashing, and
 * {@code toString}. Subclasses gain type-safety over raw {@link UUID}s while satisfying the {@code
 * DomainAttribute} contract required on entity fields.
 *
 * <pre>{@code
