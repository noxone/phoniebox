 ...
 *
 * <p>Wraps an immutable value of type {@code T} and provides correct {@link #equals}, {@link
 * #hashCode}, and {@link #toString} based on that value. Equality is class-exact: two attributes of
 * different concrete types that happen to wrap the same value are <em>not</em> equal.
 *
 * <p>Typical usage:
 *
 * <pre>{@code
