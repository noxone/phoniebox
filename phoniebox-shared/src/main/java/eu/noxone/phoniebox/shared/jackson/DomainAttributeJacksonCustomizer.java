...
/**
 * Registers the generic {@link DomainAttributeSerializer} and
 * {@link DomainAttributeDeserializer} with Quarkus's shared {@link ObjectMapper}.
 *
 * <p>Quarkus discovers this bean automatically via CDI scanning of the
 * {@code phoniebox-shared} Jandex index.  No explicit registration is needed
 * in any consuming module — adding {@code phoniebox-shared} as a dependency
 * is sufficient.
 */
@Singleton
