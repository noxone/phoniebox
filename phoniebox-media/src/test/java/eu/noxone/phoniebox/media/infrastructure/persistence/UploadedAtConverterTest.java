...
class UploadedAtConverterTest {
    ...
    void convertToDatabaseColumn_returnsIso8601String() {
        assertEquals("2024-06-15T10:30:00Z",
                converter.convertToDatabaseColumn(UploadedAt.of(FIXED_INSTANT)));
    }
    ...
    void convertToEntityAttribute_parsesIso8601String() {
        assertEquals(UploadedAt.of(FIXED_INSTANT),
                converter.convertToEntityAttribute("2024-06-15T10:30:00Z"));
    }
