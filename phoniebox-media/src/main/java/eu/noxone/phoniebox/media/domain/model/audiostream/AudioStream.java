...
public class AudioStream extends DefaultDomainEntity<AudioStreamId> implements Playable {
    ...
    private AudioStream(final AudioStreamId id, final StreamName name, final StreamUrl url, final MimeType mimeType) {
    ...
    public static AudioStream create(final StreamName name, final StreamUrl url, final MimeType mimeType) {
