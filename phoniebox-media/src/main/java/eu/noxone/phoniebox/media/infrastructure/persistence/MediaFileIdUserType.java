 ...
 *
 * <p>Unlike a JPA {@code AttributeConverter}, a {@code UserType} applies to {@code @Id} fields as
 * well as regular columns. It is registered globally via {@code @TypeRegistration} in {@code
 * package-info.java} of this package, so no annotation is needed on the domain entity.
 */
public class MediaFileIdUserType implements UserType<MediaFileId> {
  ...
  @Override
  public MediaFileId nullSafeGet(
      final ResultSet rs,
      final int position,
