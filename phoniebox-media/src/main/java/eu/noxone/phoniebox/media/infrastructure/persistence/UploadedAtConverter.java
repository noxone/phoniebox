 ...
 *
 * <p>SQLite has no native TIMESTAMP type; ISO-8601 strings sort and compare correctly.
 * The column value is an ISO-8601 string, so the factory parses it via
 * {@link Instant#parse} before wrapping it in {@link UploadedAt}.
 */
