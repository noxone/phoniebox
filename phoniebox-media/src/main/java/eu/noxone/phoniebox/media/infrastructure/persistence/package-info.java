 ...
 *
 * <p>{@link MediaFileIdUserType} and {@link AudioStreamIdUserType} are registered here so
 * that Hibernate maps their ID types to {@code VARCHAR} for every field — including
 * {@code @Id} fields where a JPA {@code AttributeConverter} would be silently ignored.
 */
