 ...
 *
 * <p>Deliberately kept flat (no nesting) for simple frontend consumption. Domain attribute values
 * are unwrapped here — the web layer is the correct place to convert domain types to serialisable
 * primitives. Mapping from the domain aggregate happens via the static factory {@link #from}.
 */
